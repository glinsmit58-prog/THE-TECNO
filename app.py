...
def home():
    ...
    all_stats = stats()
    # V54: Use actual DB games for the homepage grid instead of static FEATURED_GAMES.
    # Only show games that have at least 1 active product (product_count > 0).
    featured = [g for g in games if g.get("product_count", 0) > 0]
